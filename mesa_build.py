...
def build_models(Mcore,rho_core,L_M_whittle,L_M_start,L_M_end,NL,Teq,Xstart,Xend,Nenv,planet_dir,Xbondi,istart=0,jstart=1):
...
def run_models(Teq,sep,NL,Nenv,planet_dir,min_mass,Xbondi,Tevolve,Evolve_star):
